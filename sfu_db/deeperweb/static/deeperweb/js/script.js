...
if ( $("#optional_parameters_checkbox").length ) {
  $("#optional_parameters_checkbox").on('click', show_optional)
  show_optional()
}

function show_optional () {
  if ( document.getElementById("optional_parameters_checkbox").checked ) {
...
if ( $("#optional_parameters_checkbox2").length ) {
  $("#optional_parameters_checkbox2").on('click', show_optional2)
  show_optional2()
}

function show_optional2 () {
  if ( document.getElementById("optional_parameters_checkbox2").checked ) {
    $(".optional_parameters2").show();
  } else {
    $(".optional_parameters2").hide();
  }
}
...
function popup_login_init(){
  $(".login-popup .login-popup-wrap .close-button").on("click", function (){
    $(".login-popup").removeClass("open");
  })
  $(".login-popup .login-popup-wrap .cws-button").on("click", function (){
